...
``` bash
php artisan backpack:base:add-sidebar-content "<li><a href='{{ backpack_url('widgetmainpage') }}'><i class='fa fa-dashboard'></i> <span>{{ trans('backpack::base.dashboard') }}</span></a></li>"
